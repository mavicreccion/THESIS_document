...
\centering
    \centering
      \captionsetup{justification=centering}
    \subfloat[Pablo Ocampo (Southbound)]{\includegraphics[width=0.5\textwidth]{figures/figure_nonworkingday_peakhour_pocampo.png}\label{figure_nonworkingday_peakhour_pocampo}}
    \hfill
    \subfloat[Antipolo (Northbound)]{\includegraphics[width=0.5\textwidth]{figures/figure_nonworkingday_peakhour_antipolo.png}\label{figure_nonworkingday_peakhour_antipolo}}
...
\centering
  \centering
  \scalebox{.4}{\includegraphics{figures/autocorr_whyRE.PNG}}
...
\textbf{RNN TOM}             & 0.092                              & 0.183                             & 0                                  & 0                                 & 0.045                              & 0.072                             \\ \hline
