...
\begin{figure}[h]
  \centering
  \captionsetup{justification=centering}
  \scalebox{.65}{\includegraphics{figure_traffic_day_vs_week.PNG}}
...
\begin{figure}[h]
  \centering
  \captionsetup{justification=centering}
  \scalebox{1}{\includegraphics{figure_corr_trafficweather.PNG}}
...
\begin{figure}[h]
  \centering
  \captionsetup{justification=centering}
  \scalebox{1}{\includegraphics{figure_autocorr_weather.PNG}}
